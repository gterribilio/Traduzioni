...
--
-- Host: localhost
-- Generation Time: Giu 27, 2015 alle 19:14
...
(12, 1, 'Cooperativa Bislacchi 3', '2007-05-05', 'Ubriaco del giorno 3', 'Intermediate'),
(13, 292, 'xcgafdgsdfs', '2015-06-09', 'sgfsdg', 'Basic');
...
INSERT INTO `COMMENT` (`ID`, `DATA`, `ID_JOB`, `TIPO_JOB`, `ID_AGENZIA`, `ID_TRADUTTORE`, `COMMENTO`, `RATING`) VALUES
(1, '2015-04-15', 6, 'CORRECTION', 4, 292, 'COMMENTO 1', 4),
(2, '2015-04-16', 7, 'TRANSLATION', 6, 292, 'COMMENTO 2', 1),
(3, '2015-04-13', 62, 'CORRECTION', 6, 292, 'COMMENTO 3', 4),
(4, '2015-04-14', 8, 'CORRECTION', 6, 292, 'COMMENTO 4', 4),
(5, '2015-04-15', 42, 'TRANSLATION', 6, 292, 'COMMENTO 5', 1),
(6, '2015-04-01', 41, 'TRANSLATION', 4, 292, 'COMMENTO 6', 1),
(7, '2015-04-01', 411, 'TRANSLATION', 4, 292, 'COMMENTO 7', 1),
(8, '2015-04-01', 412, 'TRANSLATION', 4, 292, 'COMMENTO 8', 1),
(9, '2015-04-01', 413, 'TRANSLATION', 4, 292, 'COMMENTO 9', 1),
(10, '2015-04-01', 414, 'TRANSLATION', 4, 292, 'COMMENTO 10', 1),
(11, '2015-04-01', 415, 'TRANSLATION', 4, 292, 'COMMENTO 11', 1),
(12, '2015-04-01', 416, 'TRANSLATION', 4, 292, 'COMMENTO 12', 1);
...
(33, 1, 'UniversitÃ di Torino', 'Droghe leggere e molestie'),
(35, 292, 'asd', 'asddsa');
...
(1, 287, 'REVIEW', '1900-04-01', '1900-01-08', 6, 'Italian', 'English', '2013_08_02.pdf', '<p>testo tradotto preso dal DB', 12332, '11.110', '21344.230'),
(4, 1, 'CLOSED', '2015-04-23', '2015-01-07', 4, 'German', 'Greek', '2013_08_02.pdf', '<p>testo tradotto preso dal DB', 43, '51.110', '21344.230'),
(6, 287, 'REVIEW', '2015-04-23', '2015-01-08', 4, 'Italian', 'English', '2013_08_02.pdf', '<p>testo tradotto preso dal DB', 12332, '11.110', '21344.230'),
(7, 292, 'ENGAGMENT', '2015-04-23', '2015-01-07', 6, 'Italian', 'Greek', '2013_08_02.pdf', '<p>testo tradotto preso dal DB', 7474, '11.110', '21344.230'),
(8, 292, 'COMPETITION', '2015-04-23', '2015-01-07', 4, 'German', 'Greek', '2013_08_02.pdf', '<p>testo tradotto preso dal DB', 43, '51.110', '21344.230'),
(33, 292, 'REVIEW', '2015-04-23', '2015-01-07', 4, 'Italian', 'Greek', '2013_08_02.pdf', '<p>testo tradotto preso dal DB', 7474, '11.110', '21344.230');
...
(1, 1, 'REVIEW', '2015-04-13', '2015-04-30', 4, 'Italian', 'French', '2013_08_02.pdf', '<p>testo tradotto preso dal DB 66</p>', 12332, '11.130', '99.999'),
(2, 287, 'REVIEW', '2015-04-23', '2015-01-08', 4, 'Italian', 'English', '2013_08_02.pdf', '<p>testo tradotto preso dal DB 66 77 88</p>', 12332, '11.110', '21344.230'),
(3, 1, 'REVIEW', '2015-04-23', '2015-01-07', 4, 'Italian', 'Greek', '2013_08_02.pdf', '', 7474, '11.110', '21344.230'),
(4, 1, 'CLOSED', '2015-04-23', '2015-01-07', 286, 'German', 'Greek', '2013_08_02.pdf', '<p>testo tradotto preso dal DB 66 ll</p>', 43, '51.110', '21344.230'),
(5, 292, 'ENGAGMENT', '2015-04-13', '2015-04-30', 4, 'Italian', 'French', '2013_08_02.pdf', '<p>testo tradotto preso dal DB 66</p>', 12332, '11.130', '99.999'),
(7, 292, 'CLOSED', '2015-04-23', '2015-01-07', 4, 'Italian', 'Greek', '2013_08_02.pdf', '<p>asdad</p>', 7474, '11.110', '21344.230'),
(8, 292, 'IN APPROVAL', '2015-04-23', '2015-01-07', 4, 'German', 'Greek', '2013_08_02.pdf', '<p>tr 55</p>', 43, '51.110', '21344.230');
...
(9, 100, 'Italian', 'French', 'sciences', 'simultaneous interpretation', '0.00500', 'EUR - Euro'),
(14, 287, 'Italian', 'French', 'sciences', 'simultaneous interpretation', '0.00490', 'AFN - Afghani'),
(17, 292, 'Italian', 'French', 'areonautuca', 'simultaneous interpretation', '12.00000', 'EUR - Euro'),
(19, 1, 'Afrikanns', 'Albanian', 'mechanics', 'translation', '66.00000', 'ALL - Lek'),
(20, 292, 'Afrikanns', 'Albanian', 'areonautuca', 'translation', '0.00220', 'EUR - Euro');
...
(1, 'Andrea', 'Sapone', '1985-12-30', 'Japanese', 'N'),
(100, 'Paolo', 'Limonaczxcz', '1986-01-11', 'Czech', 'Y'),
(287, 'Luca', 'Sapone1', '2015-06-08', 'Italian', 'N'),
(292, 'Luca', 'Sapone', '2015-06-15', 'Italian', 'Y'),
(293, 'TradProva2', 'prova2', '2015-06-27', 'Italian', 'N'),
(294, 'Asd', 'Asd', '2015-06-18', 'Italian', 'N'),
(302, 'Andrea', 'Sapone', '1985-12-30', 'Japanese', 'N');
...
(1, 'mirko90', 'ad691b4db7c9274ba79c90626f0121c7', '889d1f4c248652943c381934ce849a9e', 'TRADUTTORE', 'gterribilio@gmail.com', 'Torino', 'Guinea Bissau', 'thumb_105461.JPG', NULL, NULL, '777', 4, 2, '0000-00-00 00:00:00'),
(4, 'agenzia', 'ad691b4db7c9274ba79c90626f0121c7', '889d1f4c248652943c381934ce849a9e', 'AGENZIA', 'gterribilio@y', 'city3', 'Argentina', 'thumb_Koala.jpg', NULL, NULL, 'vat2', 11, 3, '0000-00-00 00:00:00'),
...
(100, 'lucasa', 'c4a7daa06e31417873a216845190824b', 'ada60f5df11cc307a1c80b3706060a12', 'TRADUTTORE', 'paolo.lidasdmo@gmail.com', 'Torino', 'Indonesia', 'Desert.jpg', NULL, NULL, '123456789', 8, 5, '0000-00-00 00:00:00'),
(286, 'Agenziaprova1', 'f408202f5b1bb898ccd009b0171ae220', '1c36daa869c498af2f16efd62093ee89', 'AGENZIA', 'luca.sapone@gmail.com', '', 'Italy', NULL, NULL, NULL, NULL, 0, 0, '2015-05-30 10:46:03'),
(287, 'TraduttoreProva1', '3c991c45b10d7a145d822146c863b414', 'ca98d2b7dbe2b69d4659a42a7e730ee8', 'TRADUTTORE', 'abc@gmail.com', '', 'Italy', NULL, NULL, NULL, NULL, 4, 1, '2015-05-30 10:48:03'),
(292, 'hydras_6@msn.com', 'f64629b55f2a280b366f0bbe2605dd2a', 'ea8c705d280469f3c6e4477b4e968e59', 'TRADUTTORE', 'hydras_6@msn.com', 'turin', 'Italy', 'imageProfile.jpg', NULL, NULL, '123456', 40, 20, '2015-05-30 10:54:58'),
(293, 'TradProva2', '11cb1a719d53aaa3cef4670e2cf1deeb', '45e94ccfee7d8c25b7cb8cd149e6b131', 'TRADUTTORE', 'luca@gmail.com', '', 'Italy', NULL, NULL, NULL, NULL, 0, 0, '2015-05-30 10:56:20'),
(294, 'asdasd', 'd9cc54738038f2d4bef274efd2a33558', '78aaf7ecf7451039aa3d81f2e3529ea1', 'TRADUTTORE', 'asd@gmail.com', '', 'Italy', NULL, NULL, NULL, NULL, 0, 0, '2015-05-30 10:57:06'),
(296, 'agenzia1', 'ecd5a60e01a13399dc30c7717f66f2e1', '60a30522b62db4636cf7258bf4eb652d', 'AGENZIA', 'sdf@sdf', '', 'Australia', 'Penguins.jpg', NULL, NULL, NULL, 0, 0, '2015-06-04 10:29:04'),
(300, 'luca.sapone86@gmail.com', '07e5c61b15507937b107e7b6e5ff59cd', '3f79abff2c29f78a12208625f50d7c26', 'AGENZIA', 'luca.sapone86@gmail.com', 'Turin Area', ' Italy', 'thumb_imageProfile.jpg', NULL, NULL, NULL, 40, 10, '2015-06-04 14:54:48'),
(301, 'gterribilio@libero.it', '4aadcff20ce39bbfa2457ce2e48d994d', '3d43c26367133d5c1b63280370115b7b', 'AGENZIA', 'gterribilio@libero.it', 'Turin Area', ' Italy', 'thumb_imageProfile.jpg', NULL, NULL, NULL, 0, 0, '2015-06-06 21:13:22'),
(302, 'mirko902', 'ad691b4db7c9274ba79c90626f0121c7', '889d1f4c248652943c381934ce849a9e', 'TRADUTTORE', 'gterribilio@gmail.com', 'Torino', 'Jamaica', 'Desert.jpg', NULL, NULL, '777', 4, 1, '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Struttura della tabella `UTENTE_TEMP`
--

CREATE TABLE IF NOT EXISTS `UTENTE_TEMP` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
ALTER TABLE `COMMENT`
  ADD CONSTRAINT `FK_COMMENT_AGENZIA` FOREIGN KEY (`ID_AGENZIA`) REFERENCES `AGENZIA` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_COMMENT_TRADUTTORE` FOREIGN KEY (`ID_TRADUTTORE`) REFERENCES `TRADUTTORE` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Limiti per la tabella `JOBS_CORRECTION`
--
ALTER TABLE `JOBS_CORRECTION`
  ADD CONSTRAINT `FK_JC_ID_AGENZIA` FOREIGN KEY (`ID_AGENZIA`) REFERENCES `AGENZIA` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_JC_ID_TRADUTTORE` FOREIGN KEY (`ID_TRADUTTORE`) REFERENCES `TRADUTTORE` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
