...
home.controller('HomeTraduttoreCtrl',  ['$scope', '$rootScope', '$window', 'services', '$location', 'customFactory',
    ...
    $scope.doUpdateProfileTraduttore = function() {
    	...
    	if(conferma) {
    		...
    		services.getFromRESTServer(
    			...
    			"&citta="+$scope.cittaTraduttore+"&country="+temp_country + "&mothertongueTraduttore=" + temp_mothertongue + "&ruolo=TRADUTTORE" + 
