...
--
-- Host: localhost
-- Generation Time: Mar 27, 2015 alle 10:45
...
CREATE TABLE IF NOT EXISTS `AGENZIA` (
  ...
  `NUM_IMPIEGATI` varchar(255) NOT NULL,
...
INSERT INTO `AGENZIA` (`ID`, `NOME`, `NUM_IMPIEGATI`, `SITO_WEB`) VALUES
(4, 'aaa', '21 - 30', 'lll'),
(6, 'lucasap', '0 - 5', 'hahah.com'),
(101, 'sdf', '6 - 10', 'dsfdsf');
...
(7, 1, 'rerwe', '2015-01-01', 'fgdf', 'Basic');
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='TABELLA DEI JOBS TRANSLATION' AUTO_INCREMENT=1 ;
...
(10, 1, 'Basque', 'Armenian', 'mechanics', 'consecutive interpretation', '44', 'ALL - Lek');
...
INSERT INTO `TRADUTTORE` (`ID`, `NOME`, `COGNOME`, `DATA_NASCITA`, `MADRELINGUA`) VALUES
(1, 'Luca', 'Sapon', '1985-12-30', 'Italian'),
(2, 'gterri', 'gterri', NULL, ''),
(3, 'giu', 'terri', NULL, 'Andorra'),
(5, 'dsf', 'dsf', '0000-00-00', 'United Arab Emirates'),
(100, 'Luca', 'Sapone', '1986-08-20', 'Italy');
...
INSERT INTO `UTENTE` (`ID`, `USERNAME`, `PASSWORD`, `SALE`, `RUOLO`, `EMAIL`, `CITTA`, `PAESE`, `PAYPAL`, `IBAN`) VALUES
(1, 'mirko90', 'ad691b4db7c9274ba79c90626f0121c7', '889d1f4c248652943c381934ce849a9e', 'TRADUTTORE', 'assadsd@asd', 'Torino', 'Italy', NULL, NULL),
(2, 'mirko91', 'cd403eaabed29949b3ca651d83e7efe2', '887ba1ce18ffae173220bee0994753af', 'TRADUTTORE', 'gterri@gterri', NULL, '', NULL, NULL),
(3, 'mirko92', '9a24ac9fc308b869f96f255d102f92e7', '4cb5748684dfbf88d5082cef12e95c35', 'TRADUTTORE', 'sdf@sdf', NULL, 'United Arab Emirates', NULL, NULL),
(4, 'mirko11', '89780e946585ef1d91a3fc7a44038eb6', 'df953275d918bd310b1e6b0713ab0fe2', 'AGENZIA', 'fdsdf@sdf', NULL, 'Antigua and Barbuda', NULL, NULL),
(5, 'rrrrrr', '87376148c6d7a40b42c00717bb73cf7e', '0d99b92ddb2f24cb2b7a0f64a0ba20ad', 'TRADUTTORE', 'sdf@sdf', 'fgfd', 'Antigua and Barbuda', NULL, NULL),
(6, 'lucasap', '0c390203cde3e58ca49704979c9f9559', '56eabf79be1e4c0c72aa381eaa8694be', 'AGENZIA', 'luca.sapone86@gmail.com', NULL, '', NULL, NULL),
(100, 'lucasa', 'c4a7daa06e31417873a216845190824b', 'ada60f5df11cc307a1c80b3706060a12', 'TRADUTTORE', 'luca.sapone86@gmail.com', 'Torino', 'Italy', NULL, NULL),
(101, 'qweqwe', '77f62709cd6b924d0d9e5f58bcbc9c22', '46d7fa9fbaa9854203ac91fe34cc5420', 'AGENZIA', 'sdf@sdf', NULL, '', NULL, NULL);
